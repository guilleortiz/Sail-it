...
const PARTES = [
  { id: 'palo-mayor', label: 'Palo mayor', hotspot: { top: '15%', left: '43%' } },
  { id: 'cruceta', label: 'Cruceta', hotspot: { top: '33%', left: '43%' } },
  { id: 'estay-proel', label: 'Estay proel', hotspot: { top: '60%', left: '24%'} },
  { id: 'obenques-bajos', label: 'Obenques bajos', hotspot: { top: '60%', left: '48%' } },
  { id: 'pinzote', label: 'Pinzote', hotspot: { top: '65%', left: '44%' } },
  { id: 'obenques-altos', label: 'Obenques altos', hotspot: { top: '28%', left: '46%' } },
  { id: 'amantillo', label: 'Amantillo', hotspot: { top: '45%', left: '60%' } },
  { id: 'estay-popel', label: 'Estay de popel', hotspot: { top: '55%', left: '75%' } },
  { id: 'burdas', label: 'Burdas', hotspot: { top: '57%', left: '60%' } },
  { id: 'botavara', label: 'Botavara', hotspot: { top: '65%', left: '60%' } },
];
      ...
      <div className="flex flex-col items-center px-2 sm:px-4 py-4 sm:py-8">
        <div className="w-full max-w-md sm:max-w-2xl mb-6 sm:mb-8">
          <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6">
            <h3 className="text-lg sm:text-2xl font-semibold text-slate-800 mb-2 sm:mb-4 text-center">Jarcia Firme</h3>
            <p className="text-sm sm:text-base text-slate-600 mb-4 sm:mb-6 text-center">
              Arrastra el nombre de la parte de la jarcia firme al círculo correspondiente en la imagen.
            </p>
            {showResults ? (
              ...
              <>
                ...
                <div className="mt-4 sm:mt-6 text-slate-700 text-center text-sm sm:text-base">
                  {currentIdx + 1} de {order.length} partes
                </div>
              </>
            )}
          </div>
...
export default JarciaFirmeExercise;
