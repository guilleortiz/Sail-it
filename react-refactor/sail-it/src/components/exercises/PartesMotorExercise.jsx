...
const PARTES = [
    { id: 'tirador', label: 'Tirador de arranque', hotspot: { top: '26%', left: '45%' } },
  { id: 'acelerador', label: 'Acelerador', hotspot: { top: '35%', left: '23%' } },
  { id: 'pinzas', label: 'Pinzas de fijación', hotspot: { top: '45%', left: '40%' } },
  { id: 'pasador', label: 'Pasador de inclinación', hotspot: { top: '53%', left: '53%' } },
  { id: 'aspiracion', label: 'Aspiración de agua para refrigeración', hotspot: { top: '70%', left: '61%' } },
  { id: 'pata', label: 'Pata', hotspot: { top: '55%', left: '73%' } },
  { id: 'helice', label: 'Hélice', hotspot: { top: '77%', left: '76%' } },
      ...
      <div className="flex flex-col items-center px-2 sm:px-4 py-4 sm:py-8">
        <div className="w-full max-w-md sm:max-w-2xl mb-6 sm:mb-8">
          <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6">
            <h3 className="text-lg sm:text-2xl font-semibold text-slate-800 mb-2 sm:mb-4 text-center">Partes del Motor</h3>
            <p className="text-sm sm:text-base text-slate-600 mb-4 sm:mb-6 text-center">
              Arrastra el nombre de la parte del motor al círculo correspondiente en la imagen.
            </p>
            {showResults ? (
              ...
              <>
                ...
                <div className="relative mx-auto w-full" style={{ aspectRatio: '480/680', maxWidth: 480 }}>
                  <img
                    src="/assets/PartesMotor.png"
                    alt="Partes del motor"
...
export default PartesMotorExercise; 