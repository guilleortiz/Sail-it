...
const PARTES = [
  { id: 'arganeo', label: 'Arganeo', hotspot: { top: '35%', left: '77%' } },
  { id: 'cepo', label: 'Cepo', hotspot: { top: '28%', left: '62%' } },
  { id: 'cana', label: 'Caña', hotspot: { top: '54%', left: '52%' } },
  { id: 'cruz', label: 'Cruz', hotspot: { top: '69%', left: '38%' } },
  { id: 'brazo', label: 'Brazo', hotspot: { top: '68%', left: '54%' } },
  { id: 'una', label: 'Uña', hotspot: { top: '62%', left: '75%' } },
];
      ...
      <div className="flex flex-col items-center px-2 sm:px-4 py-4 sm:py-8">
        <div className="w-full max-w-md sm:max-w-2xl mb-6 sm:mb-8">
          <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6">
            <h3 className="text-lg sm:text-2xl font-semibold text-slate-800 mb-2 sm:mb-4 text-center">Partes del Ancla</h3>
            <p className="text-sm sm:text-base text-slate-600 mb-4 sm:mb-6 text-center">
              Arrastra el nombre de la parte del ancla al círculo correspondiente en la imagen.
            </p>
            {showResults ? (
              ...
              <>
                ...
                />
                <div className="relative mx-auto w-full" style={{ aspectRatio: '480/480', maxWidth: 480 }}>
                  <img
                    src="/assets/PartesAncla.png"
                    alt="Partes del ancla"
...
export default PartesAnclaExercise; 