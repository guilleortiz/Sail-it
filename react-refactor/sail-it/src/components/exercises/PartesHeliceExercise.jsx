...
const PARTES = [
  { id: 'borde-fuga', label: 'Borde de fuga', hotspot: { top: '34%', left: '48%' } },
  { id: 'raiz', label: 'Raiz de la hélice', hotspot: { top: '48%', left: '40%' } },
  { id: 'punta', label: 'Punta de la hélice', hotspot: { top: '50%', left: '19%' } },
  { id: 'nucleo', label: 'nucleo', hotspot: { top: '54%', left: '54%' } },
];
      ...
      <div className="flex flex-col items-center px-2 sm:px-4 py-4 sm:py-8">
        <div className="w-full max-w-md sm:max-w-2xl mb-6 sm:mb-8">
          <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6">
            <h3 className="text-lg sm:text-2xl font-semibold text-slate-800 mb-2 sm:mb-4 text-center">Partes de la Hélice</h3>
            <p className="text-sm sm:text-base text-slate-600 mb-4 sm:mb-6 text-center">
              Arrastra el nombre de la parte de la hélice al círculo correspondiente en la imagen.
            </p>
            {showResults ? (
              ...
              <>
                ...
                <div className="relative mx-auto w-full" style={{ aspectRatio: '480/680', maxWidth: 480 }}>
                  <img
                    src="/assets/PartesHelice.png"
                    alt="Partes de la hélice"
...
export default PartesHeliceExercise; 